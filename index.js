...
async function libraryApiSearch2(authToken, parameters) {
  let photos = [];
  let nextPageToken = [];
  let error = [];
...
function getAlbumsApliCall(authToken) {
  const options = {
    url: config.apiEndpoint + '/v1/albums',
    // headers: {'Content-Type': 'application/json'}, // set bu json: true
    qs: {pageSize: config.albumPageSize},
    json: true,
    auth: {'bearer': authToken},
  ...
  //   request(options)
  //   .then((data) => {
  //     console.log('*** getAlbumsApliCall data');
  //     resolve(data);
  //   })
  //   .catch((err) => {
  //     console.log('*** getAlbumsApliCall error', err);

  //     reject(err);
  //   })
  // })

  console.log('*** getAlbumsApliCall STARTING:');

  // return request(options, function(error, response, body) {
  //   if(error) {
  //     console.log('*** getAlbumsApliCall error');
  //     return reject(error);
  //   } else if (response) {
  //     console.log('*** getAlbumsApliCall response');
  //   } else {
  //     console.log('*** getAlbumsApliCall body');
  //     return resolve(body);
  //   }
  // });
...
function libraryApiGetAlbums(authToken) {
  ...
  console.log('*** libraryApiGetAlbums() calling getAlbumsApliCall():');

  getAlbumsApliCall(authToken)
  .then(function(data) {
    console.log('*** libraryApiGetAlbums() then() data:', data);
  })
  .catch(function(error) {
    console.log('*** libraryApiGetAlbums() catch() error:', error);
  })


  console.log('*** libraryApiGetAlbums response: ', result);
  ...
  // console.log('*** libraryApiGetAlbums request END, result|err: ', result | error);
